        ...
        <div class="content-body">
			...
			<div class="container-fluid">
				<div class="form-head d-flex page-titles mb-sm-4 mb-3 align-items-center">
					<div class="mr-auto">
						<h2 class="text-black font-w600"> Detail Dokter</h2>
						<ol class="breadcrumb">
					...
					<a href="app-profile.html" class="btn btn-outline-primary">Perbarui Profile</a>
				</div>
				<div class="row">
						...
						<div class="row">
							<div class="col-xl-12">
								<div class="card doctor-details-card">
									<div class="bg-img-bx">
										...
										<a href="doctor.html" class="btn btn-primary"><i class="las la-stethoscope mr-3 scale5"></i>Kulit Specialist</a>
									</div>
									<div class="card-body">
										<div class="d-sm-flex d-block mb-3">
											...
											<div class="card-info d-flex align-items-start">
												<div class="mr-auto pr-3">
													...
													Gabung di 21 August 2020, 12:45 AM</span>
												</div>
							...
							<div class="col-xl-12">
								<div class="card">
									<div class="card-header border-0 pb-0">
										<div>
											<h4 class="fs-20 text-black mb-1">Skill Dokter</h4>
							...
							<div class="col-xl-12">
								<div class="card recent-review">
									<div class="card-header border-0 pb-0">
										<h4 class="fs-20 text-black mb-1">Ulasan Terbaru</h4>
									</div>
									<div class="card-body">
										<div class="media p-3 border">
											...
											<div class="media-body row align-items-center">
												<div class="col-md-8 mb-md-0 mb-3">
													...
													<p class="fs-14">Rumah sakit & staf sangat hangat & cepat dalam membuat saya memulai prosedur</p>
													<a href="javascript:void(0)" class="btn btn-xxs btn-outline-primary mr-2">SANGAT BAIK</a>
													<a href="javascript:void(0)" class="btn btn-xxs btn-outline-primary">SANGAT BAGUS</a>
												</div>
										...
										<div class="media p-3 border">
											...
											<div class="media-body row align-items-center">
												<div class="col-md-8 mb-md-0 mb-3">
													...
													<p class="fs-14">Ketika saya datang dengan ibu saya, saya sangat gugup. Tapi setelah masuk ke sini saya merasa hangat dengan tersenyum</p>
													<a href="javascript:void(0)" class="btn btn-xxs btn-outline-primary mr-2">SANGAT BAIK</a>
													<a href="javascript:void(0)" class="btn btn-xxs btn-outline-primary">SANGAT BAGUS</a>
												</div>
												<div class="col-md-4 text-md-center">
										...
										<div class="media p-3 border">
											...
											<div class="media-body row align-items-center">
												<div class="col-md-8 mb-md-0 mb-3">
													...
													<p class="fs-14">Terima kasih untuk semua layanannya, tidak diragukan lagi ini adalah rumah sakit terbaik</p>
													<a href="javascript:void(0)" class="btn btn-xxs btn-outline-primary mr-2">>SANGAT BAIK</a>
													<a href="javascript:void(0)" class="btn btn-xxs btn-outline-primary">SANGAT BAGUS</a>
												</div>
												<div class="col-md-4 text-md-center">
						...
						<div class="row">
							<div class="col-xl-12 col-xxl-8">
								<div class="card appointment-schedule">
									<div class="card-header border-0 pb-0">
										<h4 class="fs-20 text-black mb-1">Jadwal Booking</h4>
									</div>
										...
										<div class="row">
											...
											<div class="height380 col-xl-12 col-xxl-6 col-md-6 col-sm-5 dz-scroll" id="appointmentSchedule">
												<div class="d-flex pb-3 border-bottom mb-3 align-items-end">
													<div class="mr-auto">
														<p class="text-black font-w600 mb-2">selasa 11 juni </p>
														<ul>
												...
												<div class="d-flex pb-3 border-bottom mb-3 align-items-end">
													<div class="mr-auto">
														<p class="text-black font-w600 mb-2">selasa 34 juni</p>
														<ul>
															<li><i class="las la-clock"></i>09:00 - 10:30 AM</li>
															<li><i class="las la-user"></i>Dr. Samantha</li>
														</ul>
												...
												<div class="d-flex pb-3 border-bottom mb-3 align-items-end">
													<div class="mr-auto">
														<p class="text-black font-w600 mb-2">selasa 21 juni</p>
														<ul>
															<li><i class="las la-clock"></i>09:00 - 10:30 AM</li>
															<li><i class="las la-user"></i>Dr. Samantha</li>
														</ul>
												...
												<div class="d-flex pb-3 border-bottom mb-3 align-items-end">
													<div class="mr-auto">
														<p class="text-black font-w600 mb-2">rabu 11 juni</p>
														<ul>
															<li><i class="las la-clock"></i>09:00 - 10:30 AM</li>
															<li><i class="las la-user"></i>Dr. Samantha</li>
														</ul>
							...
							<div class="col-xl-12 col-xxl-4">
								<div class="card patient-list">
									<div class="card-header border-0 pb-0">
										<h4 class="fs-20 text-black mb-0">Pasien List</h4>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right">
												...
												<a class="dropdown-item" href="#">Tolak Oder</a>
												<a class="dropdown-item" href="{{ route('patient') }}">View Detail</a>
											</div>
										</div>
									</div>
									<div class="card-body">
										<div class="d-flex mb-4">
											...
											<div>
												...
												<span class="fs-14 text-primary font-w600">Kulit</span>
											</div>
										</div>
										<div class="d-flex mb-4">
											...
											<div>
												...
												<span class="fs-14 text-primary font-w600">Jerawat</span>
											</div>
										</div>
										<div class="d-flex  mb-4">
										...
										<div class="d-flex">
											...
											<div>
												...
												<span class="fs-14 text-primary font-w600">Facial Care</span>
											</div>
										</div>
									</div>
