			...
			<div class="container-fluid">
				<div class="form-head d-flex align-items-center mb-sm-4 mb-3">
					<div class="mr-auto">
						...
						<p class="mb-0"> Admin Klinik Kecantikan Dashboard</p>
					</div>
					<a href="javascript:void(0)" class="btn btn-outline-primary"><i class="las la-cog scale5 mr-3"></i>Atur Layout</a>
				</div>
				<div class="row">
						...
						<div class="row">
								...
								<div class="card">
									<div class="card-header d-sm-flex d-block pb-0 border-0">
										<div class="mr-auto pr-3">
											<h4 class="text-black fs-20 mb-0">Pasien Persentase</h4>
										</div>
							...
							<div class="col-xl-12">
								<div class="card rated-doctors">
									<div class="card-header border-0 pb-0">
										<h3 class="fs-20 text-black mb-0 mr-auto">Dokter Berperingkat Teratas</h3>
										<a href="javascript:void(0)" class="btn-link">Lanjut >></a>
									</div>
									<div class="card-body">
										<div class="d-sm-flex pb-sm-4 pb-3 border-bottom mb-sm-4 mb-3 align-items-center">
											<div class="d-flex align-items-center mr-auto pr-2">
												...
												<div>
													<h4 class="mb-sm-2 mb-1"><a href="doctor.html" class="text-black">Dr. Yasir Asnhori</a></h4>
											...
											<div class="text-sm-right mt-sm-0 mt-3 star-review">
												...
												<span class="fs-14 text-black">315 Ulasan</span>
											</div>
										</div>
										<div class="d-sm-flex pb-sm-4 pb-3 border-bottom mb-sm-4 mb-3 align-items-center">
											<div class="d-flex align-items-center mr-auto pr-2">
											...
											<div class="text-sm-right mt-sm-0 mt-3 star-review">
												...
												<span class="fs-14 text-black">221 Ulasan</span>
											</div>
										</div>
										<div class="d-sm-flex pb-sm-4 pb-3 border-bottom mb-sm-4 mb-3 align-items-center">
											<div class="d-flex align-items-center mr-auto pr-2">
											...
											<div class="text-sm-right mt-sm-0 mt-3 star-review">
												...
												<span class="fs-14 text-black">181 Ulasan</span>
											</div>
										</div>
										<div class="d-sm-flex pb-sm-4 pb-3 border-bottom mb-sm-4 mb-3 align-items-center">
											<div class="d-flex align-items-center mr-auto pr-2">
												...
												<div>
													...
													<span class="fs-14 text-primary font-w600">Jantung</span>
												</div>
											</div>
											<div class="text-sm-right mt-sm-0 mt-3 star-review">
												<ul>
										...
										<div class="d-sm-flex pb-sm-4 pb-3 border-bottom mb-sm-4 mb-3 align-items-center">
											...
											<div class="text-sm-right mt-sm-0 mt-3 star-review">
												...
												<span class="fs-14 text-black">176 ulasan</span>
											</div>
										</div>
							...
							<div class="col-xl-12">
								<div class="card appointment-schedule">
									<div class="card-header pb-0 border-0">
										<h3 class="fs-20 text-black mb-0">Jadwal Booking</h3>
										<div class="dropdown ml-auto">
										...
										<div class="row">
											...
											<div class="col-xl-6 col-xxl-12  col-md-6 height415 dz-scroll" id="appointment-schedule">
												<div class="d-flex pb-3 border-bottom mb-3 align-items-end">
													<div class="mr-auto">
														<p class="text-black font-w600 mb-2">11 juni 2022</p>
														<ul>
															<li><i class="las la-clock"></i>09:00 - 10:30 AM</li>
															<li><i class="las la-user"></i>Dr. Yasir Anshori</li>
														</ul>
													</div>
												...
												<div class="d-flex pb-3 border-bottom mb-3 align-items-end">
													<div class="mr-auto">
														<p class="text-black font-w600 mb-2">11 april 2022</p>
														<ul>
															<li><i class="las la-clock"></i>09:00 - 10:30 AM</li>
												...
												<div class="d-flex pb-3 border-bottom mb-3 align-items-end">
													<div class="mr-auto">
														<p class="text-black font-w600 mb-2">20 maret 2022</p>
														<ul>
															<li><i class="las la-clock"></i>09:00 - 10:30 AM</li>
															<li><i class="las la-user"></i>Dr. Samantha</li>
														</ul>
												...
												<div class="d-flex pb-3 border-bottom mb-3 align-items-end">
													<div class="mr-auto">
														<p class="text-black font-w600 mb-2">2 jumat 2022</p>
														<ul>
															<li><i class="las la-clock"></i>09:00 - 10:30 AM</li>
															<li><i class="las la-user"></i>Dr. Ali</li>
														</ul>
													</div>
													<a href="javascript:void(0)" class="text-success mr-3 mb-2">
														<i class="las la-check-circle scale5"></i>
							...
							<div class="col-xl-12">
								<div class="card patient-activity">
												...
												<tbody>
														...
														<td>
															<div class="d-flex">
																...
																<div>
																	...
																	<span class="fs-14">41 thn</span>
																</div>
															</div>
														</td>
														<td>
															<div>
																<p class="fs-14 mb-1">Penyakit</p>
																<span class="text-primary font-w600 mb-auto">Sakit Kulit</span>
															</div>
														</td>
														<td>
															<div>
																<p class="fs-14 mb-1">Status</p>
																<span class="text-primary font-w600 mb-2 d-block text-nowrap">Sembuh</span>
													...
													<tr>
														...
														<td>
															<div>
																<p class="fs-14 mb-1">Penyakit</p>
																<span class="text-primary font-w600 mb-auto">Masalah Mata</span>
															</div>
														</td>
														<td>
															<div>
																<p class="fs-14 mb-1">Status</p>
																<span class="text-danger font-w600 mb-2 text-nowrap d-block">Pasien Baru</span>
																<p class="mb-0 fs-12">22/03/2020 12:34 AM</p>
															</div>
														</td>
													</tr>
													<tr>
														<td>
															<div class="d-flex">
																...
																<div>
																	<h6 class="fs-16 mb-1"><a href="patient.html" class="text-black">James Bond</a></h6>
																	<span class="fs-14">41 thn</span>
																</div>
															</div>
														</td>
														<td>
															<div>
																<p class="fs-14 mb-1">Penyakit</p>
																<span class="text-primary font-w600 mb-auto">Face Care</span>
															</div>
														</td>
														<td>
															<div>
																<p class="fs-14 mb-1">Status</p>
																<span class="text-warning font-w600 mb-2 text-nowrap d-block">Proses</span>
																<p class="mb-0 fs-12">22/03/2020 12:34 AM</p>
															</div>
														</td>
													</tr>
													<tr>
														...
														<td>
															<div>
																<p class="fs-14 mb-1">Penyakit</p>
																<span class="text-primary font-w600 mb-auto">Jerawat</span>
															</div>
														</td>
														<td>
															<div>
													...
													<tr>
														...
														<td>
															<div>
																<p class="fs-14 mb-1">Penyakit</p>
																<span class="text-primary font-w600 mb-auto">Kantung Mata</span>
															</div>
														</td>
														<td>
															<div>
																<p class="fs-14 mb-1">Status</p>
																<span class="text-warning font-w600 text-nowrap mb-2 d-block">proses</span>
																<p class="mb-0 fs-12">22/03/2020 12:34 AM</p>
															</div>
														</td>
													</tr>
													<tr>
														...
														<td>
															<div>
																<p class="fs-14 mb-1">penyakit</p>
																<span class="text-primary font-w600 mb-auto">hidung Care</span>
															</div>
														</td>
														<td>
															<div>
																<p class="fs-14 mb-1">Status</p>
																<span class="text-primary font-w600 mb-2 text-nowrap d-block">Sembuh</span>
																<p class="mb-0 fs-12">22/03/2020 12:34 AM</p>
															</div>
														</td>
													</tr>
													<tr>
														...
														<td>
															<div>
																<p class="fs-14 mb-1">penyakit</p>
																<span class="text-primary font-w600 mb-auto">Komedo</span>
															</div>
														</td>
														<td>
															<div>
																<p class="fs-14 mb-1">Status</p>
																<span class="text-danger font-w600 mb-2 text-nowrap d-block">Pasirn Baru</span>
																<p class="mb-0 fs-12">22/03/2020 12:34 AM</p>
															</div>
														</td>
													</tr>
													<tr>
														...
														<td>
															<div>
																<p class="fs-14 mb-1">Penyakit</p>
																<span class="text-primary font-w600 mb-auto">Mata Care</span>
															</div>
														</td>
														<td>
															<div>
																<p class="fs-14 mb-1">Status</p>
																<span class="text-warning font-w600 mb-2 d-block text-nowrap">Proses</span>
																<p class="mb-0 fs-12">22/03/2020 12:34 AM</p>
															</div>
														</td>
													</tr>
													<tr>
														...
														<td>
															<div>
																<p class="fs-14 mb-1">Penyakit</p>
																<span class="text-primary font-w600 mb-auto">sakit mata</span>
															</div>
														</td>
														<td>
															<div>
																<p class="fs-14 mb-1">Status</p>
																<span class="text-danger font-w600 mb-2 d-block text-nowrap">Pasien Baru</span>
																<p class="mb-0 fs-12">22/03/2020 12:34 AM</p>
															</div>
														</td>
													</tr>
									...
									<div class="card-footer text-center border-0">
										<a href="patient.html" class="btn-link">lanjut >></a>
									</div>
								</div>
							</div>
						</div>
