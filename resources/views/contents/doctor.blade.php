        ...
        <div class="content-body">
			...
			<div class="container-fluid">
				<div class="form-head d-flex mb-sm-4 mb-3">
					<div class="mr-auto">
						<h2 class="text-black font-w600">Semua Doctor</h2>
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Tambah Contact Contact</h5>
							...
							<div class="modal-body">
								<form>
									...
									<div class="form-group">
										<label class="text-black font-w500">Dokter ID</label>
										<input type="text" class="form-control">
									</div>
									<div class="form-group">
										<label class="text-black font-w500">Specialis</label>
										<input type="text" class="form-control">
									</div>
									<div class="form-group">
										<label class="text-black font-w500">Tgl Gabung</label>
							...
							<table id="example5" class="display dataTablesCard table-responsive-xl">
								...
								<tbody>
									<tr>
										...
										<td><span class="text-dark">Tidak Tersedia</span></td>
										<td>
											<div class="dropdown ml-auto text-right">
												...
												<div class="dropdown-menu dropdown-menu-right">
													<a class="dropdown-item" href="{{ route('doctordetail') }}">View Detail</a>
									...
									<tr>
										...
										<td><span class="text-nowrap">+12 4124 5125</span></td>
										<td><span class="text-primary">Tersedia</span></td>
										<td>
											<div class="dropdown ml-auto text-right">
												<div class="btn-link" data-toggle="dropdown">
													<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
