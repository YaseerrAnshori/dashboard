        ...
        ***********************************-->
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							...
							<li><a href="{{ route('patientdetail') }}">Pasien Detail</a></li>
							<li><a href="{{ route('doctor') }}">Doctor</a></li>
							<li><a href="{{ route('doctordetail') }}">Doctor Detail</a></li>
                    ...
                    <ul aria-expanded="false">
                                ...
                                <li><a href="{{ route('persediaan') }}">Persediaan Product</a></li>
                    ...
                    <ul aria-expanded="false">
                        <li><a href="page-error-400.html">Laporan Pasien</a></li>
                        <li><a href="{{ route('laporanproduct') }}">Laporan Product</a></li>
                    </ul>
                </li>
                    ...
                    {{-- <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">Laporan</a>
                                <ul aria-expanded="false">
                                    <li><a href="page-error-400.html">Pemasukan</a></li>
                                    <li><a href="page-error-403.html">Pengeluaran</a></li>
                                </ul>
                            </li>
				...
				<div class="copyright">
					<p><strong>Skin Hospital Dashboard</strong> © 2022 All Rights Reserved</p>
					<p>Made with ♥ by: Anshorii </p>
				</div>
			</div>
        </div>
        <!--**********************************
